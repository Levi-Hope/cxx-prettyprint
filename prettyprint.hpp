...
#define print(...) GET_MACRO(print0, ##__VA_ARGS__, print7, print6, print5, print4, print3, print2, print1, print0)(__VA_ARGS__)
#define print0() \
    do { cout << endl; } while(false)
#define print1(a) \
    do { auto _a = (a); cout << #a " = " << (_a) << endl; } while(false)
#define print2(a, b) \
    do { auto _a = (a); auto _b = (b); cout << #a " = " << (_a) << ", " << #b " = " << (_b) << endl; } while(false)
#define print3(a, b, c) \
    do { auto _a = (a); auto _b = (b); auto _c = (c); cout << #a " = " << (_a) << ", " << #b " = " << (_b) << ", " << #c " = " << (_c) << endl; } while(false)
...
#define print7(a, b, c, d, e, f, g) \
    do { auto _a = (a); auto _b = (b); auto _c = (c); auto _d = (d); auto _e = (e); auto _f = (f); auto _g = (g); cout << #a " = " << (_a) << ", " << #b " = " << (_b) << ", " << #c " = " << (_c) << ", " << #d " = " << (_d) << ", " << #e " = " << (_e) << ", " << #f " = " << (_f) << ", " << #g " = " << (_g)  << endl; } while(false)
